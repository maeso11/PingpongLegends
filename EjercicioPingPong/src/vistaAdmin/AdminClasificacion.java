...
public class AdminClasificacion extends JFrame {
	...
	public JLabel lblJesus;
	public JLabel lblManuel;
	public JLabel lblDavid;
	public JLabel lblPaco;
	public JLabel lblMaeso;
	public JLabel lblVictor;
	public JLabel lblTony;
	public JLabel lblCarlos;
	...
	public AdminClasificacion() {
		...
		lblSegundoA.setBounds(51, 345, 60, 14);
		...
		lblTerceroA.setBounds(51, 403, 60, 14);
		...
		lblCuartoA.setBounds(51, 455, 60, 14);
		...
		lblSegundoB.setBounds(529, 345, 60, 14);
		...
		lblTerceroB.setBounds(529, 403, 60, 14);
		...
		lblCuartoB.setBounds(529, 455, 60, 14);
		contentPane.add(lblCuartoB);

		lblJesus = new JLabel("JESUS");
		...
		lblBandera3.setBounds(196, 398, 45, 30);
		...
		lblBandera4.setBounds(197, 449, 46, 30);
		...
		lblBandera7.setBounds(689, 398, 46, 29);
		...
		lblBandera8.setBounds(689, 449, 46, 29);
		...
		lblPuntos1.setBounds(314, 290, 97, 14);
		...
		lblPuntos2.setBounds(314, 347, 97, 14);
		...
		lblPuntos3.setBounds(314, 405, 97, 14);
		...
		lblPuntos4.setBounds(314, 457, 97, 14);
		...
		lblPuntos5.setBounds(794, 290, 97, 14);
		...
		lblPuntos6.setBounds(794, 347, 97, 14);
		...
		lblPuntos7.setBounds(794, 405, 97, 14);
		...
		lblPuntos8.setBounds(794, 457, 97, 14);
		contentPane.add(lblPuntos8);

		txtPuntos1 = new JTextField();
		txtPuntos1.setFont(new Font("Rockwell Extra Bold", Font.PLAIN, 15));
		txtPuntos1.setBounds(254, 283, 33, 29);
		contentPane.add(txtPuntos1);
		txtPuntos1.setColumns(10);

		txtPuntos2 = new JTextField();
		txtPuntos2.setFont(new Font("Rockwell Extra Bold", Font.PLAIN, 15));
		txtPuntos2.setColumns(10);
		txtPuntos2.setBounds(254, 340, 33, 29);
		contentPane.add(txtPuntos2);

		txtPuntos3 = new JTextField();
		txtPuntos3.setFont(new Font("Rockwell Extra Bold", Font.PLAIN, 15));
		txtPuntos3.setColumns(10);
		txtPuntos3.setBounds(254, 398, 33, 29);
		contentPane.add(txtPuntos3);

		txtPuntos4 = new JTextField();
		txtPuntos4.setFont(new Font("Rockwell Extra Bold", Font.PLAIN, 15));
		txtPuntos4.setColumns(10);
		txtPuntos4.setBounds(254, 450, 33, 29);
		contentPane.add(txtPuntos4);

		txtPuntos5 = new JTextField();
		txtPuntos5.setFont(new Font("Rockwell Extra Bold", Font.PLAIN, 15));
		txtPuntos5.setColumns(10);
		txtPuntos5.setBounds(745, 283, 33, 29);
		contentPane.add(txtPuntos5);

		txtPuntos6 = new JTextField();
		txtPuntos6.setFont(new Font("Rockwell Extra Bold", Font.PLAIN, 15));
		txtPuntos6.setColumns(10);
		txtPuntos6.setBounds(745, 340, 33, 29);
		contentPane.add(txtPuntos6);

		txtPuntos7 = new JTextField();
		txtPuntos7.setFont(new Font("Rockwell Extra Bold", Font.PLAIN, 15));
		txtPuntos7.setColumns(10);
		txtPuntos7.setBounds(745, 398, 33, 29);
		contentPane.add(txtPuntos7);

		txtPuntos8 = new JTextField();
		txtPuntos8.setFont(new Font("Rockwell Extra Bold", Font.PLAIN, 15));
		txtPuntos8.setColumns(10);
		txtPuntos8.setBounds(745, 450, 33, 29);
		...
		btnActualizar.setFont(new Font("Rockwell Extra Bold", Font.PLAIN, 14));
		btnActualizar.setBounds(378, 525, 154, 27);
