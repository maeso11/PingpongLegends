...
public class ResultadosAdmin extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ResultadosAdmin frame = new ResultadosAdmin();
	 ...
	 * Create the frame.
	 */
	public ResultadosAdmin() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(ResultadosAdmin.class.getResource("/img/palas.png")));
		setTitle("RESULTADOS");
		setResizable(false);
		...
		lblUpgrade3.setIcon(new ImageIcon(ResultadosAdmin.class.getResource("/img/upgrade3.png")));
		lblUpgrade3.setBounds(740, 444, 70, 70);
		contentPane.add(lblUpgrade3);
		
		lblUpgrade2 = new JLabel("");
		lblUpgrade2.setIcon(new ImageIcon(ResultadosAdmin.class.getResource("/img/upgrade2.png")));
		lblUpgrade2.setBounds(740, 290, 70, 70);
		contentPane.add(lblUpgrade2);
		
		lblUpgrade1 = new JLabel("");
		lblUpgrade1.setIcon(new ImageIcon(ResultadosAdmin.class.getResource("/img/upgrade1.png")));
		lblUpgrade1.setBounds(740, 152, 70, 70);
		contentPane.add(lblUpgrade1);
		
		label_4 = new JLabel("");
		label_4.setIcon(new ImageIcon(ResultadosAdmin.class.getResource("/img/oro.png")));
		label_4.setBounds(53, 146, 77, 76);
		contentPane.add(label_4);
		
		label_3 = new JLabel("");
		label_3.setIcon(new ImageIcon(ResultadosAdmin.class.getResource("/img/plata.png")));
		label_3.setBounds(53, 284, 77, 76);
		contentPane.add(label_3);
		
		lblNewLabel_8 = new JLabel("");
		lblNewLabel_8.setIcon(new ImageIcon(ResultadosAdmin.class.getResource("/img/bronce.png")));
		lblNewLabel_8.setBounds(53, 438, 77, 76);
		contentPane.add(lblNewLabel_8);
		
		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setIcon(new ImageIcon(ResultadosAdmin.class.getResource("/img/logoPeque\u00F1o2.png")));
		...
		lblBandera1.setIcon(new ImageIcon(ResultadosAdmin.class.getResource("/img/Lilcorea.jpg")));
		...
		lblBandera4.setIcon(new ImageIcon(ResultadosAdmin.class.getResource("/img/LILwilly2.png")));
		...
		lblBandera6.setIcon(new ImageIcon(ResultadosAdmin.class.getResource("/img/LILBRASIL.png")));
		...
		lblNewLabel_2.setIcon(new ImageIcon(ResultadosAdmin.class.getResource("/img/manuelMINI.jpeg")));
		...
		lblNewLabel_3.setIcon(new ImageIcon(ResultadosAdmin.class.getResource("/img/pacoMINI.jpeg")));
		...
		lblNewLabel_4.setIcon(new ImageIcon(ResultadosAdmin.class.getResource("/img/DAVIDMINI.jpg")));
		...
		lblNewLabel_5.setIcon(new ImageIcon(ResultadosAdmin.class.getResource("/img/fondoSoloNegro.jpg")));
