...
public class InformacionTony extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					InformacionTony frame = new InformacionTony();
	...
	public InformacionTony() {
		...
		JLabel lblMisilNoLook = new JLabel("DEMONIO SHOT");
