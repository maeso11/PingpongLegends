	...
	public MenuUsuario() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				btnNewButton.setText("<HTML>Click the <FONT color=\"#000099\"><U>link</U></FONT>" 
					     + " to go to the Java website.</HTML>"); 
			}
		});
		btnNewButton.setBounds(509, 587, 89, 23);
		contentPane.add(btnNewButton);
		
		JLabel lblNewLabel_3 = new JLabel("");
		lblNewLabel_3.setIcon(new ImageIcon(MenuUsuario.class.getResource("/img/noticia2.jpg")));
		lblNewLabel_3.setBounds(509, 297, 184, 313);
		...
		JScrollPane js = new JScrollPane(ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS,ScrollPaneConstants.HORIZONTAL_SCROLLBAR_ALWAYS);
