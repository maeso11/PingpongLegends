...
public class InformacionPaco extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					InformacionPaco frame = new InformacionPaco();
	...
	public InformacionPaco() {
		...
		JLabel lblJess = new JLabel("PACO");
		...
		JLabel lblMisilNoLook = new JLabel("LA BURRAQUEN");
