...
public class InformacionDavid extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					InformacionDavid frame = new InformacionDavid();
	...
	public InformacionDavid() {
		...
		JLabel lblManzanares = new JLabel("LA SOLANA");
		...
		JLabel lblMisilNoLook = new JLabel("MUERE");
		...
		JLabel label_2 = new JLabel("4/5");
		label_2.setFont(new Font("Rockwell Extra Bold", Font.PLAIN, 15));
		label_2.setBounds(218, 399, 68, 14);
		contentPane.add(label_2);
		
		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setIcon(new ImageIcon(InformacionJesus.class.getResource("/gifs/david.gif")));
