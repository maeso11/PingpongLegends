...
public class InformacionJesus extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					InformacionJesus frame = new InformacionJesus();
	...
	public InformacionJesus() {
		...
		JLabel lblJess = new JLabel("JES\u00DAS ");
		...
		JLabel lblMisilNoLook = new JLabel("MISIL NO LOOK");
