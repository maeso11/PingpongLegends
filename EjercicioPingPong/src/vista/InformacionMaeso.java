...
public class InformacionMaeso extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					InformacionMaeso frame = new InformacionMaeso();
	...
	public InformacionMaeso() {
		...
		JLabel lblManzanares = new JLabel("MANZANARES");
		...
		JLabel lblDiamante = new JLabel("FUMADORES");
		...
		JLabel lblMisilNoLook = new JLabel("LA TABAQUINHA");
