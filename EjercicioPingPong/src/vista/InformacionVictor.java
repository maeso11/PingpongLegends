...
public class InformacionVictor extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					InformacionVictor frame = new InformacionVictor();
	...
	public InformacionVictor() {
		...
		JLabel lblMisilNoLook = new JLabel("ZUMO BIFRUTAS");
		...
		lblNewLabel.setIcon(new ImageIcon(InformacionVictor.class.getResource("/gifs/victor.gif")));
		lblNewLabel.setBounds(391, 35, 362, 341);
